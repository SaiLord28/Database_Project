...
public static void menuCliente() {
    ...
    while (true) {
        ...
        System.out.println("0. Volver");
        System.out.println("============================");
        int op = Input.leerEntero("Seleccione una opción: ");
        switch (op) {
            case 1:
                int dni = Input.leerEntero("DNI: ");
                String nombre = Input.leerTexto("Primer nombre: ");
                ...
                String calle = "Calle: " + Input.leerTexto("Calle: ");
                String carrera = "Carrera: " + Input.leerTexto("Carrera: ");
    ...
    while (true) {
        ...
        switch (op) {
            case 1:
                int dni = Input.leerEntero("\nDNI Cliente: ");
                int habitacion = Input.leerEntero("Número de habitación: ");
                String fechaLlegadaStr = Input.leerTexto("Fecha llegada (yyyy-MM-dd HH:mm): ");
                String fechaSalidaStr = Input.leerTexto("Fecha salida (yyyy-MM-dd HH:mm): ");
                LocalDateTime llegada = LocalDateTime.parse(fechaLlegadaStr.replace(" ", "T"));
                LocalDateTime salida = LocalDateTime.parse(fechaSalidaStr.replace(" ", "T"));
                Reserva r = new Reserva(dni, habitacion, llegada, salida);
                dao.insertar(r);
                break;
            case 2:
                dao.listar();
    ...
    while (true) {
        ...
        switch (op) {
            ...
            case 2:
                ...
                break;
            case 3:
                int idEliminar = Input.leerEntero("\nID del servicio: ");
